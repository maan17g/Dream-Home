...
<main class="dash-content">
    ...
    <div class="dash-page-head">
        ...
        <div class="dash-head-actions"><a href="{{ route('property.index') }}" class="dash-btn-primary"><i
        ...
        <div class="col-6 col-lg-3">
            <div class="stat-card">
                ...
                <div>
                    ...
                    <div class="stat-value">{{ Auth::user()->savedProperties()->count() }}
                    </div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="stat-card">
                ...
                <div>
                    ...
                    <div class="stat-value">{{ Auth::user()->appointments->count() }}</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="dash-panel">
                <div class="dash-panel-head">
                    <div class="dash-panel-title">Recommended For You</div><a href="{{ route('property.index') }}"
    ...
    <div class="dash-panel">
        <div class="dash-panel-head">
            <div class="dash-panel-title">Upcoming Appointments</div><a href="{{ route('user.appointments') }}"
                class="dash-link">View All</a>
        </div>
        @php
        ...
        @if ($appointment)
            <div class="d-flex align-items-center justify-content-between gap-3">
                ...
                <div class="appt-date-box">
                    ...
                    <div class="d">
                        {{ $appointment->scheduled_at ? \Carbon\Carbon::parse($appointment->scheduled_at)->format('d') : '--' }}
                    </div>
                    <div class="m">
                        {{ $appointment->scheduled_at ? \Carbon\Carbon::parse($appointment->scheduled_at)->format('M') : 'None' }}
                    </div>
                </div>
                ...
                <div class="flex-fill">
                    ...
                    <div class="dash-row-sub">
                        {{ $appointment->scheduled_at ? \Carbon\Carbon::parse($appointment->scheduled_at)->format('h:i A') : 'No Time Set' }}
                        with Agent ID: {{ $appointment->agent_id }}
                    </div>
                </div>

...
<head>
  ...
  <title>Forgot Password - Dream Home</title>
  ...
  <style>
    ...
    /* ── New for this page: success-state icon ── */
    .success-icon-circle {
    ...
    <div class="auth-form-panel">
      ...
      <div id="requestStep">
        <div class="auth-form-header">
          ...
          <p class="auth-subtitle">No worries. Enter the email linked to your account and we'll send you a link to reset your password.</p>
        </div>
        ...
        <form id="forgotForm" novalidate>
          <div class="mb-3">
            ...
            <div class="input-icon-wrap">
              ...
              <input type="email" class="form-control" id="forgotEmail" placeholder="john@example.com" required>
            </div>
            <div class="field-error" id="forgotEmailError">Please enter a valid email address.</div>
          </div>

          <button type="submit" class="btn-auth-submit" id="forgotBtn">
            <div class="btn-spinner" id="forgotSpinner"></div>
            <i class="bi bi-send" id="forgotIcon"></i>
      ...
      <div id="confirmStep" class="d-none text-center">
        <div class="success-icon-circle"><i class="bi bi-envelope-check-fill"></i></div>
        <h2 class="auth-welcome">Check Your Email</h2>
        <p class="auth-subtitle mb-4">
          We've sent a password reset link to <strong id="sentToEmail" style="color:var(--text-main);"></strong>.
          The link will expire in 15 minutes.
        </p>
        <button type="button" class="btn-auth-submit" onclick="resendLink()">
  ...
  <script>
    ...
    document.getElementById('forgotForm').addEventListener('submit', function (e) {
      ...
      setTimeout(() => {
        ...
        document.getElementById('requestStep').classList.add('d-none');
        document.getElementById('confirmStep').classList.remove('d-none');

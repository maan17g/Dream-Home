@include('auth.layout.header', ['title' => 'Login - Dream Home'])
...
<body data-theme="dark">
    ...
    <div class="auth-page">
        ...
        <div class="auth-form-panel">
            ...
            <!-- Mobile Logo -->
            <a href="{{ route('page.index') }}" class="d-flex d-lg-none align-items-center gap-2 text-decoration-none mb-4"
            ...
            <div class="auth-form-header">
                <a href="{{ route('page.index')}}" class="back-link"><i class="bi bi-arrow-left"></i> Back to Home</a>
            ...
            <!-- Login Form -->
            <form id="loginForm" novalidate method="POST" action={{ route('login.store') }}>
                <!-- Email -->
                @csrf
                <div class="mb-3">
            ...
            <div class="auth-switch">
                Don't have an account? <a href="{{ route('register.index') }}">Create one free →</a>
            </div>

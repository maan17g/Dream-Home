...
<div class="dash-body">
  <aside class="dash-sidebar" id="sidebar">
    ...
    <ul class="dash-nav"><li><a href="{{ route('agent.index') }}" class="dash-nav-link active"><i class="bi bi-grid-1x2-fill"></i><span>Dashboard</span></a></li></ul>
    <div class="dash-nav-label">Workspace</div>
    <ul class="dash-nav">
      <li><a href="{{ route('agent.properties') }}" class="dash-nav-link"><i class="bi bi-buildings-fill"></i><span>My Properties</span></a></li>
      <li><a href="{{ route('agent.appointments') }}" class="dash-nav-link"><i class="bi bi-calendar-check-fill"></i><span>Appointments</span><span class="dash-nav-badge">4</span></a></li>
      <li><a href="{{ route('agent.messages') }}" class="dash-nav-link"><i class="bi bi-chat-dots-fill"></i><span>Messages</span><span class="dash-nav-badge">3</span></a></li>
    </ul>
    <div class="dash-nav-label">Account</div>
    <ul class="dash-nav"><li><a href="{{ route('agent.profile') }}" class="dash-nav-link"><i class="bi bi-person-fill"></i><span>Profile</span></a></li></ul>
      ...
      <div class="dash-topbar-right">
        ...
        <div class="dropdown">
          <button class="dash-profile border-0" data-bs-toggle="dropdown">
            <img src="https://i.pravatar.cc/64?img=11" alt="Agent">
            <span class="dash-profile-info d-none d-sm-block"><span class="dash-profile-name d-block">John Doe</span><span class="dash-profile-role">Premium Agent</span></span>
          ...
          <div class="dropdown-menu dropdown-menu-end dash-dropdown-menu">
            <a class="dropdown-item" href="agent-profile.html"><i class="bi bi-person"></i> My Profile</a>

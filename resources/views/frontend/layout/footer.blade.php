     ...
     <div class="container">
         <div class="row g-5">
             ...
             <div class="col-lg-2 col-md-3 col-6">
                 ...
                 <ul class="footer-links">
                     <li><a href="{{ route('property.search', ['type' => 'apartment']) }}">Apartments</a></li>
                     <li><a href="{{ route('property.search', ['type' => 'villa']) }}">Villas</a></li>
                     <li><a href="{{ route('property.search', ['type' => 'house']) }}">Houses</a></li>
                     <li><a href="{{ route('property.search', ['type' => 'land']) }}">Land</a></li>
                     <li><a href="{{ route('property.search', ['type' => 'office']) }}">Office Spaces</a></li>
                 </ul>
             </div>
             <div class="col-lg-4 col-md-6">
         ...
         <div class="footer-bottom">
             ...
             <div class="footer-bottom-links">
                 ...
                 <a href="{{ route('page.termsandconditions') }}">Terms & Conditions</a>

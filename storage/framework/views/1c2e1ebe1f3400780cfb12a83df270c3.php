    ...
    <div class="container">
        ...
        <?php if($errors->any()): ?>
            <div class="alert alert-danger mb-4">
                <div class="fw-bold mb-1"><i class="bi bi-x-circle me-1"></i> Please correct the following search issues:</div>
                <ul class="mb-0 ps-3">
        ...
        <section class="filter-top-wrap mb-4">
            <form action="<?php echo e(route('property.search')); ?>" method="GET" id="filterForm">
                ...
                <div class="filter-top-head d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('property.index')); ?>" class="btn-reset-all text-decoration-none" id="btnResetAll">
...
unset($__errorArgs, $__bag); ?>" 
                            placeholder="Search by title or location..." id="searchInput" value="<?php echo e(request('search')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="bedrooms">
...
unset($__errorArgs, $__bag); ?>" id="bathrooms">
                            <option value="">Any</option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="filter-group">
                        ...
                        <input type="number" name="min_area" class="form-control <?php $__errorArgs = ['min_area'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                            placeholder="e.g. 1000" id="minArea" value="<?php echo e(request('min_area')); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="d-flex justify-content-between mb-2">
        ...
        <span class="range-value" id="priceValue">$<?php echo e(number_format(request('max_price', 50000))); ?></span>
    </div>
    <input 
        type="range" 
        class="form-range <?php $__errorArgs = ['max_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
        ...
        max="50000" 
        step="50"
        value="<?php echo e(request('max_price', 50000)); ?>" 
        id="priceRange"
...
unset($__errorArgs, $__bag); ?>
        ...
        <section>
            <div class="sort-dropdown d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                ...
                <select class="form-select w-auto" id="sortBy" onchange="document.getElementById('hiddenSort').value = this.value; document.getElementById('filterForm').submit();">
...
<?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="col-12 text-center py-5">
                        ...
                        <p class="text-muted">Try adjusting your filters or resetting them to find matching properties.</p>
...
<?php echo $__env->make('frontend.layout.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\amana\Desktop\dream-home-real-estate_2\estate\resources\views/frontend/property.blade.php ENDPATH**/ ?>
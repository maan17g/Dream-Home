...
<main class="dash-content">
    ...
    <div class="dash-page-head">
        <div>
            ...
            <p class="dash-page-desc">Here's what's new since your last visit.</p>
        </div>
        <div class="dash-head-actions"><a href="<?php echo e(route('property.index')); ?>" class="dash-btn-primary"><i
                    class="bi bi-search"></i> Browse Properties</a></div>
    </div>
        ...
        <div class="col-6 col-lg-3">
            <div class="stat-card">
                ...
                <div>
                    ...
                    <div class="stat-value"><?php echo e(Auth::user()->savedProperties()->count()); ?>
        ...
        <div class="col-6 col-lg-3">
            <div class="stat-card">
                ...
                <div>
                    ...
                    <div class="stat-value"><?php echo e(Auth::user()->appointments->count()); ?></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="dash-panel">
                <div class="dash-panel-head">
                    <div class="dash-panel-title">Recommended For You</div><a href="<?php echo e(route('property.index')); ?>"
                        class="dash-link">View All</a>
                </div>
                <div class="row g-3">
                    <?php
...
<?php endif; ?>
    ...
    <div class="dash-panel">
        <div class="dash-panel-head">
            <div class="dash-panel-title">Upcoming Appointments</div><a href="<?php echo e(route('user.appointments')); ?>"
                class="dash-link">View All</a>
        </div>
        <?php
        ...
        <?php if($appointment): ?>
            <div class="d-flex align-items-center justify-content-between gap-3">
                ...
                <div class="appt-date-box">
                    ...
                    <div class="d">
                        <?php echo e($appointment->scheduled_at ? \Carbon\Carbon::parse($appointment->scheduled_at)->format('d') : '--'); ?>

                    </div>
                    <div class="m">
                        <?php echo e($appointment->scheduled_at ? \Carbon\Carbon::parse($appointment->scheduled_at)->format('M') : 'None'); ?>
                ...
                <div class="flex-fill">
                    ...
                    <div class="dash-row-sub">
                        <?php echo e($appointment->scheduled_at ? \Carbon\Carbon::parse($appointment->scheduled_at)->format('h:i A') : 'No Time Set'); ?>

                        with Agent ID: <?php echo e($appointment->agent_id); ?>
...
<?php /**PATH C:\Users\amana\Desktop\dream-home-real-estate_2\estate - Copy\resources\views/user/user-dashboard.blade.php ENDPATH**/ ?>
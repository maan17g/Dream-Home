     ...
     <div class="container">
         <div class="row g-5">
             <div class="col-lg-4 col-md-6">
                 ...
                 <p class="footer-tagline">Building places you're proud to call home — today, tomorrow, and for every
                     milestone in between.</p>

                 <div class="footer-socials align-self-end">
                     ...
                     <a href="#" class="footer-social-icon"><i class="fab fa-x"></i></a>
             ...
             <div class="col-lg-2 col-md-3 col-6">
                 ...
                 <ul class="footer-links">
                     ...
                     <li><a href="<?php echo e(route('property.search', ['type' => 'house'])); ?>">Houses</a></li>
                     <li><a href="<?php echo e(route('property.search', ['type' => 'land'])); ?>">Land</a></li>
         ...
         <div class="footer-bottom">
             <p class="footer-copyright mb-0">&copy; 2025 <span>Dream Home</span>. All Rights Reserved. Built with care.
             </p>
             <div class="footer-bottom-links">
                 <a href="<?php echo e(route('page.privacyPolicy')); ?>">Privacy Policy</a>
                 <a href="<?php echo e(route('page.termsandconditions')); ?>">Terms & Conditions</a>
...
<?php /**PATH C:\Users\amana\Desktop\dream-home-real-estate_2\estate - Copy\resources\views/frontend/layout/footer.blade.php ENDPATH**/ ?>
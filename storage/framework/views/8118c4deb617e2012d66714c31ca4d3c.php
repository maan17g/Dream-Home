...
<?php echo $__env->make('auth.layout.header', ['title' => 'Verify Email - Dream Home'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      ...
      <div id="verifyStep">
        <div class="auth-form-header text-center">
          ...
          <p class="auth-subtitle">
            ...
            <strong id="userEmail" style="color:var(--text-main);"><?php echo e(Auth::user()->email); ?></strong>
          </p>
        </div>

        <form id="verifyForm" action="<?php echo e(route('otp.verify')); ?>" method="POST" novalidate>
          <?php echo csrf_field(); ?>
          <div class="otp-row">
...
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <i class="bi bi-exclamation-circle-fill me-1 text-danger"></i> <?php echo e($message); ?>
    ...
    <?php echo csrf_field(); ?>
     ...
     <span id="resendTimer" class="d-none">Resend in <strong id="timerCount">60</strong>s</span>
        ...
        <div class="auth-switch">
          <a href="<?php echo e(route('register.index')); ?>">← Back to Register</a>
        </div>
      </div>
...
<?php /**PATH C:\Users\amana\Desktop\dream-home-real-estate_2\estate\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>
<div class="col-lg-4 col-md-6 fprop-card">
    <div class="position-relative h-100">
        ...
        <?php if(auth()->user()?->role !== 'agent' && auth()->user()?->role !== 'admin' && !request()->routeIs('user.index')): ?> 
            
        
        <button type="button" class="card-fav-btn position-absolute top-0 end-0 m-3 z-3 js-fav-btn"
        data-url="<?php echo e(route('properties.save', $property->id)); ?>" aria-label="Save property">
        <i
        class="bi <?php echo e($property->savedProperties->contains('user_id', auth()->id()) ? 'bi-heart-fill text-success' : 'bi-heart'); ?>"></i>
    </button>
        <?php endif; ?>

        
        <a href="<?php echo e(route('property.show', $property->id)); ?>" class="text-decoration-none d-block h-100">
            <div class="card property-card border-0 h-100">
                ...
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <p class="card-location mb-3 d-flex align-items-center">
                        ...
                        <?php echo e($property->city?->city); ?>, <?php echo e($property->city?->country); ?>
...
<?php /**PATH C:\Users\amana\Desktop\dream-home-real-estate_2\estate - Copy\resources\views/components/property.blade.php ENDPATH**/ ?>
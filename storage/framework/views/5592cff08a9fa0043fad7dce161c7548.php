<?php echo $__env->make('user.layout.header', ['title' => 'My Profile | Dream Home'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<main class="dash-content">
    <div class="dash-breadcrumb"><a href="<?php echo e(route('user.index')); ?>">Home</a> / <span class="current">Profile</span></div>
    ...
    <div class="avatar-wrapper">
        ...
        <?php if(Auth::user()->avatar): ?>
            <img id="avatar-preview" class="avatar-preview" src="<?php echo e(asset('storage/' . Auth::user()->avatar)); ?>" alt="Profile Picture">
...
<?php /**PATH C:\Users\amana\Desktop\dream-home-real-estate_2\estate\resources\views/user/user-profile.blade.php ENDPATH**/ ?>
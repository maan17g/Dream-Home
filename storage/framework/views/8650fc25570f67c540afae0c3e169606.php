...
<body>
    ...
    <div class="dash-body">
        ...
        <aside class="dash-sidebar" id="sidebar">
            <a href="<?php echo e(route('page.index')); ?>" class="dash-logo">
            ...
            <ul class="dash-nav">
                <li>
                    <a href="<?php echo e(route('admin.index')); ?>"
                        class="dash-nav-link <?php echo e(request()->routeIs('admin.index') ? 'active' : ''); ?>">
            ...
            <ul class="dash-nav">
                <li>
                    <a href="<?php echo e(route('admin.users')); ?>"
                        class="dash-nav-link <?php echo e(request()->routeIs('admin.users') ? 'active' : ''); ?>">
                        <i class="bi bi-people-fill"></i><span>Users</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('admin.agents')); ?>"
                        class="dash-nav-link <?php echo e(request()->routeIs('admin.agents') ? 'active' : ''); ?>">
                        <i class="bi bi-person-badge-fill"></i><span>Agents</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('admin.property')); ?>"
                        class="dash-nav-link <?php echo e(request()->routeIs('admin.property*') ? 'active' : ''); ?>">
            ...
            <ul class="dash-nav">
                <li>
                    <a href="<?php echo e(route('admin.cms')); ?>"
                        class="dash-nav-link <?php echo e(request()->routeIs('admin.cms*') ? 'active' : ''); ?>">
                        <i class="bi bi-layout-text-window-reverse"></i><span>Reviews</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('amenities.index')); ?>"
                        class="dash-nav-link <?php echo e(request()->routeIs('amenities.index*') ? 'active' : ''); ?>">
                        <i class="bi bi-layout-text-window-reverse"></i><span>Amenities</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('admin.appointment')); ?>"
                        class="dash-nav-link <?php echo e(request()->routeIs('admin.appointment*') ? 'active' : ''); ?>">
            ...
            <div class="dash-sidebar-footer">
                <ul class="dash-nav">
                    ...
                    <li><a href="<?php echo e(route('admin.destroy')); ?>" class="dash-nav-link"><i
                ...
                <div class="dash-topbar-right">
                    <div class="dropdown">
                        <button class="dash-profile border-0" data-bs-toggle="dropdown">
                            <img src="<?php echo e(asset('storage/' . Auth::user()->avatar)); ?>" alt="Admin">
...
<?php /**PATH C:\Users\amana\Desktop\dream-home-real-estate_2\estate - Copy\resources\views/admin/layout/header.blade.php ENDPATH**/ ?>
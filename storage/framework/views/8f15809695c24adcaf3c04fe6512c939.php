<?php echo $__env->make('frontend.layout.header', ['title' => 'Privacy Policy - Dream Home'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="container">
      <div class="cta-box">
        ...
        <div class="d-flex flex-wrap gap-3 justify-content-center">
          <a href="<?php echo e(route('property.index')); ?>" class="btn btn-consult px-4 py-3 shadow-sm" style="font-size:1rem;"><i class="bi bi-house-door me-2"></i> Return To Listings</a>
        </div>
      </div>
    </div>
  </section>
...
<?php echo $__env->make('frontend.layout.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\amana\Desktop\dream-home-real-estate_2\estate\resources\views/frontend/privacyPolicy.blade.php ENDPATH**/ ?>